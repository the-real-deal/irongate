...
import { ACTIVITIES_STRUCTURE, AVAILABILITIES_STRUCTURE, COURIERS_STRUCTURE, DELIVERIES_STRUCTURE, DEVICES_STRUCTURE, ENGAGED_DEVICES_STRUCTURE, ENGAGED_INMATES_STRUCTURE, ENGAGED_PERSONNEL_STRUCTURE, ENGAGED_SECTORS_STRUCTURE, ENUM_TABLES, enumStructure, GUESTS_STRUCTURE, INMATES_STRUCTURE, MOVEMENTS_STRUCTURE, PARTECIPATIONS_STRUCTURE, PEOPLE_STRUCTURE, PERSONNEL_STRUCTURE, REPORTS_STRUCTURE, ROUTINES_STRUCTURE, SECTORS_STRUCTURE, SURVEILLANCES_STRUCTURE, VEHICLES_STRUCTURE, VISITORS_STRUCTURE, VISITS_STRUCTURE, ZONES_STRUCTURE } from "../../common/structures"
import { createCRUDRouter, CRUDRouterOptions } from "./core/crud"
