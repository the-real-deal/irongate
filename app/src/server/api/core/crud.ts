...
import { DBTable, recordPrimaryKey, TableRecord, TableStructure } from "../../../common/db"
import CRUDOperations, { SanitizeError } from "../../core/crud"
import { PrimitiveRequest } from "../../middlewares"
import { HttpStatusCode } from "../../../common/http"
import utils from "../../../common/utils"

export function createCRUDRouter<T extends DBTable<TableRecord>>(
    tableName: string,
    ...
    router.get("/", async (req: PrimitiveRequest, res) => {
        ...
        try {
            const result = await crud.get(primaryKey)
            if (result === null) {
