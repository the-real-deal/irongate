...
ADD CONSTRAINT `EngagedInmates_Reports_FK` FOREIGN KEY (`ReportID`) REFERENCES `Reports`(`ID`);
...
ALTER TABLE `Availabilities`
ADD CONSTRAINT `Availabilities_Activities_FK` FOREIGN KEY (`ActivityID`) REFERENCES `Activities`(`ID`);
